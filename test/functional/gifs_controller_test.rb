...
class GifsControllerTest < ActionController::TestCase
  ...
  test "should create gif" do
    assert_difference('Gif.count') do
      post :create, gif: { datetime: @gif.datetime, downvotes: @gif.downvotes, upvotes: @gif.upvotes, url: @gif.url }
    end
  ...
  test "should update gif" do
    put :update, id: @gif, gif: { datetime: @gif.datetime, downvotes: @gif.downvotes, upvotes: @gif.upvotes, url: @gif.url }
    assert_redirected_to gif_path(assigns(:gif))
  end
